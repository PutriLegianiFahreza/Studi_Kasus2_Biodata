...
public class UpdateActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        int confirmation = this.biodataFrame.showConfirmation("update");
        ...
        if (confirmation == 0) {
            ...
            this.biodataFrame.showAlertSuccess("diupdate");
        ...
        // Jika confirmation nilai opsi no
            ...
            this.biodataFrame.showAlertFailed("diupdate");
        }
